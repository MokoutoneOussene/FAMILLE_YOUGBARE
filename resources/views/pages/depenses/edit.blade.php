                ...
                <div class="row align-items-center justify-content-between">
                    <div class="col-auto mt-5">
                        <h1 class="page-header-title">
                            ...
                            Modification de la dépenses N° ; {{ $finds->id }}
                        </h1>
                ...
                <div class="card mb-4">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-lg-12">
                                <!-- Tabbed dashboard card example-->
                                <form action="{{ route('gestion_depenses.update', [$finds->id]) }}" method="POST">
                                    @method('PATCH')
                                    @csrf
                                    <div class="row mb-3">
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-lg-6 col-md-12">
                                            <label>Motif</label>
                                            <input type="text" class="form-control" name="motif" value="{{ $finds->motif }}">
                                        </div>
                                        <div class="col-lg-6 col-md-12">
                                            <label>Montant</label>
